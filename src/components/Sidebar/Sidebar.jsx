  ...
  return (
    ...
    >
      ...
      <div className=" mb-28 text-gray-200 mx-3 flex gap-3">
        ...
        <a
          href="https://github.com/sandhya-exe"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          href="https://twitter.com/ExeSandhya"
          target="_blank"
          rel="noreferrer"
        >
          <p className=" hover:border border-gray-200 p-1 font-medium w-fit rounded cursor-pointer text-sm flex items-center gap-1">
        ...
        <a
          href="https://www.linkedin.com/in/sandhya-exe/"
          target="_blank"
          rel="noreferrer"
        >
          <p className=" hover:border border-gray-200 p-1 font-medium w-fit rounded cursor-pointer text-sm flex items-center gap-1">
        ...
        <a
          href="https://www.instagram.com/_sandhya.exe/"
          target="_blank"
          rel="noreferrer"
        >
          <p className=" hover:border border-gray-200 p-1 font-medium w-fit rounded cursor-pointer text-sm flex items-center gap-1">
        ...
        <a
          href="https://leetcode.com/sandhya_exe/"
          target="_blank"
          rel="noreferrer"
        >
          <p className=" hover:border border-gray-200 p-1 font-medium w-fit rounded cursor-pointer text-sm flex items-center gap-1">
